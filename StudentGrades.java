...
public class StudentGrades{
	public static void main (String args[]){
		...
		System.out.println();
		System.out.print("Enter you English subject marks : ");
		int Eng=sc.nextInt();
		System.out.println();
		System.out.print("Enter you Hindi subject marks : ");
		int Hin=sc.nextInt();
		System.out.println();
		System.out.print("Enter you Mathametics subject marks : ");
		int Math=sc.nextInt();
		System.out.println();
		System.out.print("Enter you Physics subject marks : ");
		int Phy=sc.nextInt();
		System.out.println();
		System.out.print("Enter you Biology subject marks : ");
		int Bio=sc.nextInt();
		System.out.println();
		System.out.print("Enter you Social subject marks : ");
